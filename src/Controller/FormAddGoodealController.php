...
class FormAddGoodealController extends AbstractController
{
    ...
    public function checkForm(array $data): array
    {
        ...
        foreach($data as $key => $value){
            ...
            if($key === "zipcode" && is_int ($cleanValue)){
                $errors[$key] = "Code Postal non valide, merci d'utiliser un Code Postal valide";
            }
        ...
        $checkedData = [];
           ...
           if($_SERVER["REQUEST_METHOD"] === 'POST'){
               ...
               if(empty($checkedData["errors"])){
                ...
                $addGoodealManager->addGoodeal($checkedData["gooDeal"]);
